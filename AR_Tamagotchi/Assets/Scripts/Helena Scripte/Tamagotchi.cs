...
namespace Character
{
    public class Tamagotchi : CharacterBasic
    {
        ...
        public void SocializingTheFino()
        {
            if (!gameOver)
            {
                Debug.Log("Teddy <3");
        ...
        {
            var nameText = GameObject.Find("NameText").GetComponent<Text>();
            nameText.text = PlayerPrefs.GetString(PlayerPref.Name, "Fino"); 

            startAge = PlayerPrefs.GetFloat(PlayerPref.Age, 0);
            happiness = PlayerPrefs.GetFloat(PlayerPref.Happy, 100);
            energy = PlayerPrefs.GetFloat(PlayerPref.Energy, 100);
            hunger = PlayerPrefs.GetFloat(PlayerPref.Hunger, 100);
            social = PlayerPrefs.GetFloat(PlayerPref.Social, 100);
        }

        public override void SetPlayerPrefs()
        {
            var nameText = GameObject.Find("NameText").GetComponent<Text>();
            PlayerPrefs.SetString(PlayerPref.Name, nameText.text);

            PlayerPrefs.SetFloat(PlayerPref.Age, startAge);
            PlayerPrefs.SetFloat(PlayerPref.Happy, happiness);
            PlayerPrefs.SetFloat(PlayerPref.Energy, energy);
            PlayerPrefs.SetFloat(PlayerPref.Hunger, hunger);
            PlayerPrefs.SetFloat(PlayerPref.Social, social);
        }

        public override void ResetPlayerPrefs()
        {
            PlayerPrefs.SetString(PlayerPref.Name, "");
            PlayerPrefs.SetFloat(PlayerPref.Age, 0);
            PlayerPrefs.SetFloat(PlayerPref.Happy, 100);
            PlayerPrefs.SetFloat(PlayerPref.Energy, 100);
            PlayerPrefs.SetFloat(PlayerPref.Hunger, 100);
            PlayerPrefs.SetFloat(PlayerPref.Social, 100);
        }
    }
}